...
train_path = '/home/adarshc/Thesis/ILSVRC2012_img_val/'
test_path = '/home/adarshc/Thesis/ILSVRC2012_img_val/'

local train_files = require 'val_file_list_part_1'
local test_files = require 'val_file_list_part_2'
local train_labels = require 'val_ground_truth_part_1'
local test_labels = require 'val_ground_truth_part_2'
...
tedata = {}
for i=1, tesize do
  local img_raw = image.load(test_path .. test_files[i]):mul(255)
  if img_raw:dim() == 2 then
    img_raw = img_raw:view(1,img_raw:size(1),img_raw:size(2))
  end
  if img_raw:size(1) == 1 then
