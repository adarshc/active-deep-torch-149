...
function train()
   ...
   local correct_predictions = 0
    ...
    if active_learning_flag then
      ...
      -- generating informativeness measure randomly
      random_measures = torch.rand((trsize - current_pool_size))
      ...
      top_k_values, top_k_indices = random_measures:topk(samples_added_per_update, true)
