...
if network == 'small' then
   ...
   ParamBank:init("/home1/adarshc/Thesis/overfeat-weights/net_weight_0")
...
elseif network == 'big' then
   ...
   -- init file pointer
   print('==> overwrite network parameters with pre-trained weights')
   ParamBank:init("/home1/adarshc/Thesis/overfeat-weights/net_weight_1")
...
train_path = '/home1/adarshc/Thesis/FaceScrub/'
test_path = '/home1/adarshc/Thesis/FaceScrub/'
...
function calculateExpectedGradientLength(sample)
  ...
  top_k_predictions, top_k_classes = prediction:topk((total_classes*egl_top_k_factor), true)
  ...
  for counter = 1,(total_classes*egl_top_k_factor) do
    ...
    current_measure = current_measure + current_egl_weights[counter]*torch.norm(current_grad_parameters)
  end
